...
import AvailabilityTable from "./AvailabilityTable/AvailabilityTableContainer";

const PaperRipple = (props) => (
	<Ripple
		{...props}
...
class Edit extends React.Component {
	...
	render() {
		...
		return (
			<div className="PackageEdit main">
				<h3>Administrare pachete</h3>
				...
				<PaperRipple
					...
					className="primary medium-big"
				>
					<i className="icon-plus" /> Adauga pachet
				</PaperRipple>
														...
														(success, errors) => {
															if (success) {
																...
																if (errors) {
																	...
																	window.alert(
																		"Operatia nu a fost efectuata deoarece s-au inregistrat erori. Va rugam incercati mai tarziu."
																	);
																}
															}
														}
				...
				>
					<div className="PackageEditPopup">
						...
						{fp ? (
							<h3>
								{fp.Id || fp.Id === 0 ? "Modificare Pachet" : "Adaugare Pachet"}
							</h3>
						) : null}
						{fp ? (
							<form>
								<ul>
									{fp.Id || fp.Id === 0 ? (
										<li>
											<label>Id</label>
											<input type="text" defaultValue={fp.Id} disabled={true} />
										</li>
									) : null}
									<li>
						...
						<div className="actions">
							<PaperRipple
								...
								onClick={() => {
									...
									Utils.putJSON("/api/package", fp, (success, errors) => {
										if (success) {
											closeModal();
											this.refresh();
										} else {
